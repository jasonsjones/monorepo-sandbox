...
<div class="container">
    ...
    <a class="btn" href="${url}/confirmemail/${user.emailVerificationToken}">Verify Email</a>
    <p class="text">or click on the below link:</p>
    <p class="text"><a href="${url}/confirmemail/${user.emailVerificationToken}">${url}/confirmemail/${user.emailVerificationToken}</a></p>
...
${url}/confirmemail/${user.emailVerificationToken}
    `;
};
